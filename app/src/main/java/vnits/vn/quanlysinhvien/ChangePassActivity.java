...
public class ChangePassActivity extends Activity {
    ...
    public void eventClick() {
        btnYes = (Button) findViewById(R.id.btnYesPassword);
        btnNo = (Button) findViewById(R.id.btnNoPassword);
    ...
    public void moveActivity() {
        Intent intent = new Intent(ChangePassActivity.this, ViewPaperActivity.class);
